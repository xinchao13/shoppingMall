<form action="/address/addAddress" method="post" id="theForm"
		...
		<tbody>
			<tr>
				...
				<td align="left"><span class="dia_txt"> <input
						name="trueName" type="text" id="trueName" value="" size="35"
						required="required">
				</span></td>
			</tr>
			<tr>
				...
				</select> <input type="button" name="area_edit" id="area_edit" value="修改"
					style="display: none;"
			...
			<tr>
				...
				<td align="left"><span class="dia_txt"> <input
						name="area_info" type="text" id="area_info" value="" size="35"
						required="required">
				</span></td>
			</tr>
			<tr>
				...
				<td align="left"><span class="dia_txt"> <input
						name="zip" type="text" id="zip" value="" size="35"
						required="required">
				</span></td>
			</tr>
			<tr>
				...
				<td align="left"><span class="dia_txt"> <input
						name="telephone" type="text" id="telephone" value="" size="35"
						required="required">
				</span></td>
			</tr>
			<tr>
