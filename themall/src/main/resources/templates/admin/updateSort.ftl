...
<!-- saved from url=(0085)http://192.168.1.233:11585/shopping/admin/goods_class_edit.htm?id=65961&currentPage=1 -->
...
jQuery(".icon_sys a[icon='']").addClass("this");
});
	...
	<div class="cont">
		...
		<div class="settab">
			<span class="tab-one"></span> <span class="tabs"> <a
				...
				href="/admin/sort/toInsertSort">新增</a> | <a
				href="javascript:void(0)" class="this">编辑</a>
			</span> <span class="tab-two"></span>
		</div>
		<form name="theForm" id="theForm" action="/admin/sort/updateSort"
			method="post" enctype="multipart/form-data" novalidate="novalidate">
			<input name="id" type="hidden" id="id" value="${sort.id}"> <!--   <input name="currentPage" type="hidden" id="currentPage" value="1"> -->
				<!--   <input name="list_url" type="hidden" id="list_url" value="http://192.168.1.233:11585/shopping/admin/goods_class_list.htm"> -->
				<!--   <input name="add_url" type="hidden" id="add_url" value="http://192.168.1.233:11585/shopping/admin/goods_class_add.htm"> -->
				<div class="setcont">
					<ul class="set1">
						<li><strong class="orange fontsize20">*</strong>分类名称</li>
						<li><span class="webname"> <input name="sortName"
								type="text" id="sortName" value="${sort.sortName}" size="40"></span></li>
					</ul>
					<!--鼠标未经过样式-->
					<ul class="set1">
					...
					<ul class="set1">
						<li>显示</li>
						<input name="display" id="display" type="hidden"
							value="${sort.display?string('true','false')}"> <img
							src="/images/on.jpg" width="61" height="23" id="displayOn"
							onclick="displayState();" style="cursor: pointer"> <img
								src="/images/off.jpg" width="61" height="23" id="displayOff"
								onclick="displayState();" style="cursor: pointer">
					</ul>
					<ul class="set1">
						<li>排序</li>
						<li><span class="webname"> <input name="sort"
								type="text" id="sort" value="${sort.sort}"></span><span
							id="nothis"><strong class="q"></strong><strong class="w">序号越小，分类显示越靠前</strong><strong
								class="c"></strong></span></li>
					</ul>
				</div>
		</form>
