  ...
  jQuery("#theForm").validate({
    rules:{
	  name:{
	    required :true,
	     remote:{
		    url: "/admin/spec/updatespecname",     //后台处理程序
            type: "post",               //数据发送方式
...
<body>
	<form action="/admin/spec/updateSpec" method="post" name="theForm"
		id="theForm" novalidate="novalidate">
		<input name="id" id="id" type="hidden" value="${spec.id}"> <input
			name="add_url" type="hidden" id="add_url" value="#"> <input
				name="list_url" type="hidden" id="list_url" value="#"> <input
					name="count" type="hidden" id="count">
						<div class="cont">
							<h1 class="seth1">规格管理</h1>
							<div class="settab">
								<span class="tab-one"></span> <span class="tabs"> <a
									href="/admin/spec/toShowSpec">管理</a> | <a
									href="/admin/spec/toInsertSpec">新增</a> | <a
									href="javascript:void(0)" class="this">编辑</a>
								...
								<div class="editul ">
									<ul class="set3">
										...
										<li><span class="pxnum"> <input name="name"
												type="text" id="name" value="${spec.specname}"></span><span
											id="nothis"><strong class="q"></strong><strong
												class="w">请填写常用的商品规格的名称；例如：颜色；尺寸等。</strong><strong class="c"></strong></span></li>
									</ul>
									<ul class="set3">
										<li>排序</li>
										<li><span class="pxnum"> <input name="sequence"
												type="text" id="sequence" value="${spec.seq}"></span><span
											id="nothis"><strong class="q"></strong><strong
												class="w">请填写整数。类型列表将会根据排序进行由小到大排列显示。</strong><strong
...
//    jQuery.post("#",{"id":id},function(data){
//      if(data=="true"){
 	    jQuery(obj).remove();	   
...
count++;
  var goods_spec_property_text="<tr id='goods_spec_'><td width='82'><span class='pxnum size5'><input name='newSpecvSeqs' id='sequence_count' value='' type='text'></span></td><td width='271'><span class='pxnum size7'><input name='newSpecvnames' id='value_count' value='' type='text'></span></td><td class='ac8' align='center' width='116'><a href='javascript:void(0);' onclick='remove_goods_spec_property(this.parentNode.parentNode,\"\")'>删除</a></td></tr>";
								...
								<div class="specification">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0"
										...
										<tbody>
											...
											<input name="delids" type="hidden" id="delids" value="">
												<#list listSpecv as specv>
												<tr id="goods_spec_property">
													<td width="82"><span class="pxnum size5"> <input
															name="ids" type="hidden" id="ids" value="${specv.id}">
																<input name="specvSeqs" type="text" id="sequence_1"
																value="${specv.seq}"></span></td>
													<td width="271"><span class="pxnum size7"> <input
															name="specvnames" type="text" id="value_1"
															value="${specv.specvname}"></span></td>
													<td width="116" align="center" class="ac8"><a
														href="javascript:void(0);"
														onclick="delids2(this.parentNode.parentNode,${specv.id})">删除</a>
													</td>
												</tr>
												</#list>
												<tr>
