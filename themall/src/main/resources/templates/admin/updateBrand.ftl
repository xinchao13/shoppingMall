...
<!-- saved from url=(0068)http://192.168.1.233:11585/shopping/admin/goods_brand_edit.htm?id=94 -->
...
jQuery("#theForm").validate({
    rules:{
	  name:{
	    required :true,
	     remote:{
		    url: "/admin/brand/updatebrandname",     //后台处理程序
            type: "post",               //数据发送方式
...
<body>
	<form action="/admin/brand/updateBrand" method="post"
		...
		<input name="id" id="id" type="hidden" value="${brand.id}"> <input
			name="cmd" id="cmd" type="hidden"> <input name="list_url"
				type="hidden" id="list_url" value=""> <input name="add_url"
					type="hidden" id="add_url" value="">
						<div class="cont">
							<h1 class="seth1">品牌管理</h1>
							<div class="settab">
								<span class="tab-one"></span> <span class="tabs"> <a
									href="/admin/brand/tobrandlist">管理</a> | <a
							...
							<div class="setcont" id="base">
								...
								<ul class="set1">
									...
									<li><span class="webname"> <input name="name"
											type="text" id="name" value="${brand.brandName}"></span></li>
								</ul>

								<ul class="set1">
									<li><strong class="orange fontsize20"></strong>首字母</li>
									<li><span class="webname"> <input name="firstword"
											type="text" id="first_word" value="${brand.initial}"></span><span
								...
								<ul class="set1">
									...
									<li><span class="size13"><input name="textfield"
										...
										style="float: left;" class="file"> <input
											name="brandLogo" type="file" id="brandLogo" size="30"
											onchange="show(this)"></span> <span class="preview">
											<img id="img" src="${brand.imgpath}" width="25" height="25"
											id="brandImgShow">
									</span> <span id="nothis"><strong class="q"></strong><strong
											class="w">最佳尺寸93*33，支持格式gif,jpg,jpeg,png</strong><strong
											class="c"></strong></span>
										<div class="bigimgpre" id="brandImg" style="display: none;">
											<img src="/images/1a79c85a-74a8-4037-a7dd-8f2ece391753.jpg">
										</div></li>
								</ul>
								...
								<ul class="set1">
									...
									<li><span class="webSwitch"> <input
											name="recommend" id="recommend" type="hidden"
											value="${brand.recommend?string('true','false')}"> <img
								...
								<ul class="set1">
									...
									<li><span class="webname"> <input name="sequence"
											type="text" id="sequence" value="${brand.req}"></span><span
										id="nothis"><strong class="q"></strong><strong
