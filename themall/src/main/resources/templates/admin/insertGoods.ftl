...
<body>
	<form action="/admin/goods/toInsertGoods" method="post"
		...
		<div class="cont">
			...
			<div class="settab">
				<span class="tab-one"></span> <span class="tabs"> <a
					href="/admin/goods/toshowgoodslist">所有商品</a> | <a class="this"
					href="javascript:void(0)">新增商品</a> | <a
					href="/admin/goods/toupdategoods">编辑商品</a>
			...
			<div class="setcont" id="base">
				...
				<ul class="set1">
					...
					<li><span class="webname"> <input name="oldprice"
							type="text" id="first_word" value=""></span></li>
				</ul>
				<ul class="set1">
				...
				<ul class="set1">
					...
					<li><span class="webnamesec sizese"> <select
							name="brandid" id="goods.goods_brand.id">
				...
				<ul class="set1">
					...
					<li><span class="description"> <textarea
								name="description" rows="10" cols="30"></textarea>
					</span></li>
				</ul>
				...
				<ul class="set1">
					...
					<li><span class="webSwitch"> <input name="statu"
							id="statu" type="hidden" value="true"> <img
					...
					<li><span class="size13"><input name="textfield0"
						...
						style="float: left;" class="file"> <input name="goodImg0"
							type="file" id="brandLogo" size="30" onchange="show(this,0)">
								<img id="img0" src="" /></span> <span class="preview"></span> <span
