...
<!-- saved from url=(0051)http://192.168.1.233:11585/shopping/buyer/order.htm -->
  ...
  jQuery(".li_10>a[id^=li_ship_]").click(function(){
     jQuery("div[id^=li_ship_box]").hide();
					...
					var display =jQuery("#li_ship_box_"+order_id).css("display");
							...
							jQuery.post("http://192.168.1.233:11585/shopping/buyer/query_ship.htm",{
									"id":order_id
									},
									function(data){
											if(data){
...
function order_delete(){
	 ...
	 window.location.href="http://192.168.1.233:11585/shopping/buyer/order_delete.htm?id="+order_id+"&currentPage=1";
}
//
});
</script>
...
jQuery(document).ready(function(){
  ...
  jQuery(".user_ser_btn").click(function(){
		...
		<form action="/goods/toshowOrder" method="post" id="SearchForm">
		...
		<div class="user_center">
			<form action="/goods/toshowOrder" method="post" id="ListForm">
...
jQuery(document).ready(function(){
	...
	jQuery(".sellul>li>a").click(function(){
	  ...
	  if(child_show=="true"){
	    jQuery(this).parent().find("img").attr("src","http://192.168.1.233:11585/shopping/resources/style/system/front/default/images/usercenter/menucontract.jpg");
	    jQuery(this).parent().find("ul").slideUp('normal');
	    jQuery(this).attr("child_show","false");
	  }else{
	    jQuery(this).parent().find("img").attr("src","http://192.168.1.233:11585/shopping/resources/style/system/front/default/images/usercenter/menuspread.jpg");
									...
									<div class="product_manage2">
										...
										<ul class="sellul">
											<li><a href="javascript:void(0);" child_show="true"><b><img
														src="/images/menuspread.jpg" width="10" height="10"></b>我的购物</a>
												<ul>
													<li op="order" class="this"><a
														href="http://192.168.1.233:11585/shopping/buyer/order.htm">订单管理</a></li>
													<!--             <li op="integral"><a href="http://192.168.1.233:11585/shopping/buyer/integral_order_list.htm">积分兑换</a></li> -->
													<li op="coupon"><a
														href="http://192.168.1.233:11585/shopping/buyer/coupon.htm"
														class="other">我的优惠券</a></li>
												</ul></li>

											<li><a href="javascript:void(0);" child_show="true"><b><img
														src="/images/menuspread.jpg" width="10" height="10"></b>退款维权</a>
												<ul>
													<li op="report"><a
														href="http://192.168.1.233:11585/shopping/buyer/report.htm">举报管理</a></li>
													<li op="consult"><a
														href="http://192.168.1.233:11585/shopping/buyer/consult.htm">咨询管理</a></li>
													<li op="complaint"><a
														href="http://192.168.1.233:11585/shopping/buyer/complaint.htm">投诉管理</a></li>
												</ul></li>

											<li><a href="javascript:void(0);" child_show="true"><b><img
														src="/images/menuspread.jpg" width="10" height="10"></b>收藏管理</a>
												<ul>
													<li op="favorite_store"><a
														href="http://192.168.1.233:11585/shopping/buyer/favorite_store.htm">店铺收藏</a></li>
													<li op="favorite_goods"><a
														href="http://192.168.1.233:11585/shopping/buyer/favorite_goods.htm">商品收藏</a></li>
												</ul></li>
									...
									<div class="chat_box">
										<div class="chat_box_l" style="display: none">
											...
											<div class="chat_box_l_ul">
												<span class="tp"><a href="javascript:void(0);"
													mark="t" id="user_slide_t"><b>︿</b></a></span>
												<!--用户列表-->
												<ul id="ul_user_list">
												</ul>
											...
											<div class="chat_box_send">
												<input id="user_id" name="user_id" type="hidden" value="">
													<input id="ids" name="ids" type="hidden" value="">
														<span id="chatting_show_error"
														style="color: #F00; float: left;"></span> <span
														style="color: #999;">按Enter键发送消息</span> <input
...
jQuery("#contact_un").val("");		
									...
									<div class="chat_bottom">
										<div class="chat_bottom_l"
											style="cursor: pointer; display: none;" id="Contacting"></div>
							...
							<td id="centerbg" valign="top"><div class="buyer_position">
									<div class="buyer_p_box">
										<a href="http://192.168.1.233:11585/shopping/buyer/index.htm">买家中心</a>
										&gt; <span>订单列表</span>
									</div>
								</div>
								<div class="productmain">
									<div class="pdctitle blue2">
										订单列表 <input type="hidden" name="delete_order_id"
											id="delete_order_id">
									</div>
									<div class="ordersear">
										<span>订单号：</span><span class="ordersp1 size7"> <input
											name="order_id" type="text" id="order_id"
											value="${map.order_id!}"></span> <span>下单时间：</span> <span
											class="ordersp1 size8"> <input name="beginTime"
											type="date"></span> <span>——</span> <span
											class="ordersp1 size8"> <input name="endTime"
											type="date"></span> <span>订单号：</span><span>订单状态：</span> <span
											class="ordersel"> <select name="order_status"
											id="order_status">
										...
										</span> <span class="orderbtn"> <input name="input"
											type="submit" value="搜索" style="cursor: pointer;"></span>
									</div>
									<div class="myorder">
										<#list listOrder as order> <#if order.orderstatus !=5>
										<div class="Order">
											<div class="Order_box">
												<div class="line01">
													<ul>
														<li class="li_01">订单号：<span>${order.ordernum}</span></li>
														<li class="li_02">下单时间：<span>${order.addtime?string("yyyy-MM-dd
																HH:mm:ss")}</span></li>
														<li class="li_03"><a
															href="/goods/todetailorder?ordernum=${order.id}"
															target="_blank">查看订单</a></li>
														<li class="li_02">支付方式：<span>未支付</span></li>
														<li class="li_02">订单状态：<span><#if
																	order.orderstatus==0> 待付款 <#elseif
																	order.orderstatus==1> 待发货 <#elseif
																	order.orderstatus==2> 已发货 <#elseif
																	order.orderstatus==3> 已收货 <#elseif
																	order.orderstatus==4> 已完成 <#else> 已取消
																</#if></span></li>
														...
														<tbody>
															<tr>
																<td>
																	<ul class="ul_01">
																		<li class="li_05"><a
																			href="/shopping/goods_98690.htm" target="_blank"><img
																				src="${detailOrder.goods.imgpath}" width="60"
																				height="60"></a></li>
																		<li class="li_06"><a
																			href="/shopping/goods_98690.htm" target="_blank">${detailOrder.goods.goodname}</a>
																			<span>数量:${detailOrder.count}</span> <span></span></li>
																	</ul>
																</td>
																<td><ul class="ul_02">
																		<li style="color: #999;">物流跟踪</li>
																		<li class="li_07">暂无物流信息
																			<div class="li_07_box" id="li_ship_box_230288"
																				style="display: none">
																				<span><img src="/images/Order_10.png"></span>
																				<ul>
																				</ul>
																			</div>

																			<div class="li_ship_box_loading"
																				id="li_ship_box_loading_230288"
																				style="display: none">
																				<span><img src="/images/Order_10.png"></span>
																				<b> <img src="/images/loading.gif"><br>
																							正在查询物流信息...</b>
																			</div>
																		</li>
																	</ul></td>
																<td><ul class="ul_03">
																		<li><a href="/shopping/store_32848.htm"
																			target="_blank">电商自营店</a></li>
																		<li><span>15942611130</span> <a
																			href="http://192.168.1.233:11585/shopping/buyer/message_send.htm?userName=15942611130"
																			target="_blank"><img src="/images/order_04.gif"
																				width="15" height="11"></a></li>
																		<li><a target="_blank"
																...
																<#if detailOrder_has_next>
																<td>
																	<ul class="ul_02">
																		<li style="color: #999;"></li>
																		<li style="color: #59cfff;"></li>
																	</ul>
																</td>
																<#else>
																<td><ul class="ul_02">
																		<li style="color: #999;">¥#{order.ordersum;m2M2}</li>
																...
																<td style="border: none">
																	<ul class="ul_04">
																		...
																		<li><a
																			...
																			dialog_uri="/goods/cancelorder?orderid=${order.id}&currentPage=1"
																			dialog_title="取消订单" dialog_width="400"
																			dialog_height="100" dialog_id="order_cancel">取消订单</a></li>
																		<li class="li_09"><a
																			href="/goods/payorder?orderid=${order.id}"
																			target="_blank">付款</a></li>
																		<#elseif order.orderstatus==1>
																		<li class="li_09"><a
																			href="/goods/remind?orderid=${order.id}">提醒卖家发货</a></li>
																		<#elseif order.orderstatus==2>
																		<li class="li_09"><a
																			href="/goods/confirmget?orderid=${order.id}">确认收货</a></li>
																		<#elseif order.orderstatus==3>
																		<li class="li_09"><a
																			href="/goods/aspire?orderid=${order.id}">评价</a></li>
																		<#elseif order.orderstatus==4>
																		<li class="li_09"><a
																			href="/goods/ruanDelete?orderid=${order.id}">删除订单</a></li>
																		<#else>
																		<li class="li_09"><a
																			href="/goods/yingDelete?orderid=${order.id}">删除</a></li></#if>
																	</ul>
																</td>
											...
											<div class="alldel">
												<div class="userfenye">
													<input name="currentPage" type="hidden" id="currentPage"
														...
														页 <a href="javascript:void(0);"
														onclick="return gotoPage(2)">下一页</a> <a
														href="javascript:void(0);" onclick="return gotoPage(2)">末页</a>
												</div>
											</div>
										</div></td>
						</tr>
...
jQuery(document).ready(function(){
	...
	if(top==0){
		...
		<div class="back_box"
			...
			<div class="back_top">
				<a id="toTop"
					href="http://192.168.1.233:11585/shopping/buyer/order.htm#"
	...
	<!-- <div id="order_cancel"> -->
	<!-- 	<div class="white_content ui-draggable" style="position: absolute; top: 58px; left: 451px; width: 400px;">  -->
	<!-- 	<a href="javascript:void(0);" dialog_uri="undefined" class="white_close" onclick="javascript:jQuery(&quot;#order_cancel&quot;).remove();"></a> -->
	<!-- 		<div class="white_box"><h1 style="cursor: move;">取消订单</h1> -->
	<!-- 			<link href="/css/window.css" type="text/css" rel="stylesheet"> -->
	<!-- 			<form action="/goods/cancelorder?orderid=" method="post" id="theForm"> -->
	...
	<!-- 			        <input name="id" type="hidden" id="id" value="230306"> -->
	<!-- 			      </td> -->
	<!-- 			      <td align="left">3305420210604104504</td> -->
	<!-- 			    </tr> -->
	<!-- 			    <tr> -->
	...
	<!-- 			  </tbody></table> -->
	<!-- 			</form> -->
	<!-- </div></div><div class="black_overlay" style="height: 2087px;"></div></div> -->
</body>
</html>